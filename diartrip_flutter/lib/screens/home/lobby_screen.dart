  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text(lang.translate('lobby.newTrip')),
      ),
      body: isWide
          ? Row(children: [
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(lang.translate('lobby.noTrips'), style: const TextStyle(color: AppTheme.onSurfaceMuted)),
            const SizedBox(height: 8),
            OutlinedButton.icon(
              onPressed: () => Navigator.pushNamed(context, '/nova-viagem'),
              icon: const Icon(Icons.add, size: 16),
              label: Text(lang.translate('lobby.createFirst')),
            ),
          ],
        ),
      );
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Text(lang.translate('lobby.aiAssistant'), style: const TextStyle(fontWeight: FontWeight.w600)),
              const Spacer(),
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text(lang.translate('lobby.thinking'), style: const TextStyle(color: AppTheme.onSurfaceMuted, fontSize: 13)),
                      ],
                    ),
                  );
                }

    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        title: Text(existing == null
            ? lang.translate('itinerary.add')
            : lang.translate('itinerary.edit')),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            TextField(
              controller: tituloCtrl,
              decoration: InputDecoration(labelText: lang.translate('itinerary.title')),
              autofocus: true,
            ),
            const SizedBox(height: 10),
            TextField(
              controller: descCtrl,
              decoration: InputDecoration(labelText: lang.translate('itinerary.description')),
              maxLines: 3,
            ),
          ],
        ),
        actions: [
          ...
          ElevatedButton(
              ...
              child: Text(lang.translate('itinerary.save'))),
        ],
      ),
    );
    if (ok != true) return;
      ...
      body: _loading
          ...
          : RefreshIndicator(
              ...
              child: _roteiros.isEmpty
                  ? Center(
                      child: Text(lang.translate('itinerary.empty'),

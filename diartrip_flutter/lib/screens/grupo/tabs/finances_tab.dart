  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          _card(lang.translate('finances.paid'), 'R\$ ${p.totalPagoPorMim.toStringAsFixed(2)}',
              Icons.payment, AppTheme.success),
          const SizedBox(height: 10),
          _card(lang.translate('finances.debt'), 'R\$ ${p.minhaDividaAtual.toStringAsFixed(2)}',
              Icons.account_balance_wallet, AppTheme.warning),
          const SizedBox(height: 16),
          Text(lang.translate('finances.recentExpenses'), style: const TextStyle(fontWeight: FontWeight.w600)),

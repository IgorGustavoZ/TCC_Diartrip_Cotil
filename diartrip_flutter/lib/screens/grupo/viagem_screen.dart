...
class _ViagemScreenState extends State<ViagemScreen>
  ...
  Widget build(BuildContext context) {
    ...
    if (_grupo == null) {
      return Scaffold(
        appBar: AppBar(title: Text(lang.translate('viagem.title'))),
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Text(lang.translate('viagem.error'),
                  style: const TextStyle(color: AppTheme.onSurfaceMuted)),
              const SizedBox(height: 16),
              OutlinedButton(
                  onPressed: _load, child: Text(lang.translate('viagem.retry'))),
            ],
          ),
        ),
      );
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(text: lang.translate('viagem.tabs.overview')),
            Tab(text: lang.translate('viagem.tabs.finances')),
            Tab(text: lang.translate('viagem.tabs.admin')),
            Tab(text: lang.translate('viagem.tabs.expenses')),
            Tab(text: lang.translate('viagem.tabs.itinerary')),
            Tab(text: lang.translate('viagem.tabs.photos')),
            Tab(text: lang.translate('viagem.tabs.chat')),
            Tab(text: lang.translate('viagem.tabs.info')),
          ],
        ),
      ),

...
const TRANSLATIONS = {
  en: {
    ...
    'viagem.settings.destinationChangeTitle': 'Change the destination?',
    'viagem.settings.destinationChangeBody': 'Changing the destination will delete all current itinerary items for this trip, since they were planned for the previous destination.',
    'viagem.settings.destinationChangeConfirm': 'Change destination',
  ...
  'pt-BR': {
    ...
    'viagem.settings.destinationChangeTitle': 'Alterar o destino?',
    'viagem.settings.destinationChangeBody': 'Alterar o destino excluirá todos os roteiros atuais desta viagem, pois eles foram planejados para o destino anterior.',
    'viagem.settings.destinationChangeConfirm': 'Alterar destino',

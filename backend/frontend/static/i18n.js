...
const TRANSLATIONS = {
  en: {
    ...
    'viagem.leaveConfirm': 'Are you sure you want to leave this trip?',
    'viagem.leaveError': 'Could not leave the trip',
    'viagem.deleteTrip': '🗑 Delete trip',
    'viagem.deleteConfirm': 'Delete this trip? This will remove the trip and end the participation of all members. This action cannot be undone.',
  ...
  'pt-BR': {
    ...
    'viagem.leaveConfirm': 'Tem certeza que deseja sair desta viagem?',
    'viagem.leaveError': 'Não foi possível sair da viagem',
    'viagem.deleteTrip': '🗑 Excluir viagem',
    'viagem.deleteConfirm': 'Excluir esta viagem? Essa ação removerá a viagem e encerrará a participação de todos os membros. Essa ação não poderá ser desfeita.',

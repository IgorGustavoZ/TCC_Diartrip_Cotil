...
def _default_cursor(*args, **kwargs):
    ...
    c.fetchone.return_value = {
        ...
        "id_mensagem": 1,
        "cargo": "admin",
        "senha_hash": "$2b$04$ducseYqWmvWtI/uSEsMtq.ZPQzr5p2YIAe335YKoG3xIe0F8bT5jK",
        "nome": "Mock User",
        "email": "mock@test.com",
        "nome_grupo": "Mock Group",
        "codigo_convite": "MOCK123",
        "conteudo": "Mock message",
        "data_envio": datetime(2026, 1, 1, 0, 0, 0, tzinfo=timezone.utc),
        "data_criacao": datetime(2026, 1, 1, 0, 0, 0, tzinfo=timezone.utc),
        "foto_perfil": None,
        "total_consumido": 0.0,
...
_redis_mod._ultima_tentativa = _time.monotonic()  # simula "tentou agora" → espera 30s

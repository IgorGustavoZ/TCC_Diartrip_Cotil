...
# Blacklist em memória: jti -> timestamp de expiração
# Funciona para deployment single-process (TCC/portfolio).
# Para múltiplos workers/containers, substituir por Redis.
...
def revogar_token(token: str) -> None:
    """Adiciona o JTI do token à blacklist. Silencia erros de token inválido."""
    try:
